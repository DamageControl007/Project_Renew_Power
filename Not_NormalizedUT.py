...
def Mass(Normal,rows,cols,list):
    ...
    for i in range(0,rows):
        ...
        for j in range(0,cols):
            ...
            print("Num concentration= ", Normal[i][j])
            print("dia= ", list[j])
...
print("df_Mass= ", df_Mass)

# Normalized_Mass=(r"G:\OneDrive - IIT Delhi\Courses\Sem8\MTP CLD880\New Codes in Jupyter\Final excel files\Total_Mass.xlsx")
